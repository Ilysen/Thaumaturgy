...
{
	internal class Thaumaturgy : Mod
	{
		public Thaumaturgy()
		{
		...
		public override void AddRecipes() // Thaumaturgy has a *lot* of recipes, so they're organised into regions
		{
			// Many vanilla items have alternate recipes in Thaumaturgy
			#region Vanilla - Accessories/Items
			...
			#endregion Vanilla - Accessories/Items

			// And one of Thaumaturgy's focuses is a different alchemy system
			...
			#endregion Vanilla - Potions

			#region Calamity - Potions
			...
			#endregion Calamity - Potions

			// Auric shards can be used with catalysts to transmute prey fish into quest fish
			#region Vanilla - Fish
			...
			#endregion Vanilla - Fish

			// Transmutation is otherwise used to turn items into other items
			...
			#endregion Transmutation

			// Duplicate mundane materials like dirt and stone with aura
			#region Replication - Mundane
			...
			#endregion Replication - Mundane

			// Duplicate more advanced materials like pre-Hardmode ores
			#region Replication - Kaleidoscopic
			...
			#endregion Replication - Kaleidoscopic

			// Duplicate all materials, like pillar shards and luminite
			#region Replication - Celestial
			...
			#endregion Replication - Celestial
		}
	}

	internal class ThaumaturgyGlobalNPC : GlobalNPC
	{
