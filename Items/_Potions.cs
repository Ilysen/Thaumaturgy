...
namespace Thaumaturgy.Items
{
	...
	{
		public override string Texture => "Thaumaturgy/Textures/Alchemy/PotionAvarice";
	...
	{
		public override string Texture => "Thaumaturgy/Textures/Alchemy/PotionEvasion";
	...
	{
		public override string Texture => "Thaumaturgy/Textures/Alchemy/PotionGlacialHighway";
	...
	{
		public override string Texture => "Thaumaturgy/Textures/Alchemy/PotionVoid";
	...
	{
		public override string Texture => "Thaumaturgy/Textures/Alchemy/PotionWateryEmbers";
	...
	public class PotionSoothingEmbers : ModItem
	{
		public override string Texture => "Thaumaturgy/Textures/Alchemy/PotionSoothingEmbers";
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Potion of Soothing Embers");
			Tooltip.SetDefault("The embers of a peace candle\nTremendously reduces enemy spawn rate");
		}
