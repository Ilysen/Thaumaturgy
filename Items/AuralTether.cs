...
namespace Thaumaturgy.Items
{
	public class AuralTether : ModItem
	{
		...
		public override string Texture => "Thaumaturgy/Textures/Items/AuralTether";
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Left-click to mark a point in space\n" +
				...
				"Can't be used from within your inventory; must be on your hotbar");
		}
		...
		{
			Texture2D texture = mod.GetTexture("Textures/Items/AuralTether");
			if (markedPoint != default)
			{
				texture = mod.GetTexture("Textures/Items/AuralTether_Set");
			}
		...
		{
			// Prevents accidentally clearing/setting mark while in your inventory
